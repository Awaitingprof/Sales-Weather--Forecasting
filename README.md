...
-COUNTRY (string) — Country of the store
-PRODUCT_ID (string) — Unique product identifier
-PRODUCT_NAME (string) — Name of the product
-CATEGORY (string) — Product category
-SALES_DATE (datetime) — Date of the sales record
-TOTAL_UNITS_SOLD (int) — Number of units sold (Target variable)
-TOTAL_REVENUE (float) — Revenue generated
-AVG_UNIT_PRICE (float) — Average unit price of product
-AVG_TEMP (float) — Average daily temperature
-MAX_TEMP (float) — Maximum daily temperature
-MIN_TEMP (float) — Minimum daily temperature
-AVG_SUNSHINE (float) — Average sunshine hours
-AVG_WEATHER_CODE (int) — Encoded weather condition
